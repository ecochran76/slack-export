...
- a shared extraction-provider boundary that keeps the current host-local toolchain as the default path while allowing future provider-routed OCR/extraction follow-up work
