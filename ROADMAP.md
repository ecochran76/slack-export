...
- post-release channel-management usability under `0151` adds a dedicated
  `slack-mirror-channel-management` skill plus MCP/API `channels.create` for
  create-or-reuse channel workflows with invitee resolution
