...
def _runtime_reports_index_html(
    ...
    *,
    ...
    return (
        ...
        "function setReportCreateFieldState(fieldName,isInvalid){const fields={name:reportNameInput,base_url:baseUrlSelect,timeout:document.getElementById('report-timeout')};const field=fields[fieldName];if(!field)return;field.classList.toggle('field-invalid',!!isInvalid);field.setAttribute('aria-invalid',isInvalid?'true':'false');}"
        ...
        "if(validationError){setReportCreateFieldState(validationError.field,true);setReportCreateError(validationError.message);setReportFeedback(validationError.message,true);return;}"
...
def _exports_index_html(exports: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "function setExportCreateFieldState(fieldName,isInvalid){const fields={workspace:workspaceSelect,channel:channelSelect,day:dayInput,tz:document.getElementById('export-tz'),audience:document.getElementById('export-audience')};const field=fields[fieldName];if(!field)return;field.classList.toggle('field-invalid',!!isInvalid);field.setAttribute('aria-invalid',isInvalid?'true':'false');}"
        ...
        "if(validationError){setExportCreateFieldState(validationError.field,true);setExportCreateError(validationError.message);setExportFeedback(validationError.message,true);return;}"
