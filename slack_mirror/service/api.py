...
def _runtime_reports_index_html(
    ...
    *,
    ...
    return (
        ...
        "function setReportCreateFieldState(fieldName,isInvalid){const field=getReportCreateField(fieldName);if(!field)return;field.classList.toggle('field-invalid',!!isInvalid);field.setAttribute('aria-invalid',isInvalid?'true':'false');field.setAttribute('aria-describedby','report-create-error');}"
        ...
        "if(validationError){setReportCreateFieldState(validationError.field,true);setReportCreateError(validationError.message);setReportFeedback(validationError.message,true);focusReportCreateField(validationError.field);return;}"
...
def _exports_index_html(exports: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "function setExportCreateFieldState(fieldName,isInvalid){const field=getExportCreateField(fieldName);if(!field)return;field.classList.toggle('field-invalid',!!isInvalid);field.setAttribute('aria-invalid',isInvalid?'true':'false');field.setAttribute('aria-describedby','export-create-error');}"
        ...
        "if(validationError){setExportCreateFieldState(validationError.field,true);setExportCreateError(validationError.message);setExportFeedback(validationError.message,true);focusExportCreateField(validationError.field);return;}"
