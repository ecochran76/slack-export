...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_search_kw.add_argument(
        "--query",
        required=True,
        help="query text (supports from:/participant:/user:, channel:/source:/in:, before:/after:/since:/until:/on:, is:, has:link, has:attachment, filename:, mime:, extension:/ext:, attachment-type:, quoted phrases, and -term)",
    )
    ...
    p_search_sem.add_argument(
        "--query",
        required=True,
        help="semantic query text (supports from:/participant:/user:, channel:/source:/in:, before:/after:/since:/until:/on:, is:, has:link, has:attachment, filename:, mime:, extension:/ext:, attachment-type:, quoted phrases, and -term)",
    )
