...
# local env naming can be workspace/app-specific too, e.g.
SLACK_MIRROR_POLYCY_BOT_TOKEN=...
SLACK_MIRROR_POLYCY_USER_TOKEN=...
SLACK_MIRROR_POLYCY_APP_TOKEN=...
SLACK_MIRROR_POLYCY_SIGNING_SECRET=...
