...
The latest managed snapshots are also readable through the local API at `/v1/runtime/reports`, `/v1/runtime/reports/{name}`, `/v1/runtime/reports/latest`, `/runtime/reports`, `/runtime/reports/{name}`, and `/runtime/reports/latest`.
