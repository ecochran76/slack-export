...
The latest managed snapshots are also readable through the local API at `/v1/runtime/reports`, `/v1/runtime/reports/{name}`, `/runtime/reports`, and `/runtime/reports/{name}`.
