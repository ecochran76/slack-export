...
class ApiServerTests(unittest.TestCase):
    ...
    def test_tenant_settings_page_lists_onboarding_surface(self):
        ...
        self.assertIn("tenant-onboard-panel", page.text)
        self.assertIn("tenant-credentials-panel", page.text)
        self.assertIn("collapsible-card", page.text)
        self.assertIn("collapsible-summary", page.text)
        self.assertIn("layout-full", page.text)
        self.assertIn("Mirrored DB", page.text)
        self.assertIn("History sync", page.text)
        self.assertIn("Live sync", page.text)
        self.assertIn("Health", page.text)
        self.assertIn("embedding pending ${Number(dbStats.embedding_pending||0)}", page.text)
        self.assertIn("derived pending ${Number(dbStats.derived_pending||0)}", page.text)
        self.assertIn("webhooks ${webhooksState}", page.text)
        self.assertIn("daemon ${daemonState}", page.text)
    ...
    def test_runtime_reports_endpoints(self):
        ...
        self.assertIn("class='auth-topbar'", index_html.text)
        self.assertIn("class='nav-link active' href=\"/runtime/reports\"", index_html.text)
        self.assertIn("Create runtime report", index_html.text)
        self.assertIn("create-report-button", index_html.text)
        self.assertIn("report-create-error", index_html.text)
        ...
        self.assertIn("report-row-error-morning-ops", index_html.text)
        self.assertIn("report-row-state-morning-ops", index_html.text)
        ...
        self.assertIn("setInlineManagerRowError(", index_html.text)
        self.assertIn("setInlineManagerRowOutcome(", index_html.text)
        self.assertIn("inline-state show", index_html.text)
        self.assertIn("'saved'", index_html.text)
        self.assertIn("'error'", index_html.text)
        self.assertIn("setCreateReportBusyState(", index_html.text)
        self.assertIn("setReportCreateError(", index_html.text)
        self.assertIn("validateReportCreateForm(", index_html.text)
        self.assertIn("setReportCreateFieldState(", index_html.text)
        self.assertIn("clearReportCreateFieldState(", index_html.text)
        self.assertIn("focusReportCreateField(", index_html.text)
        self.assertIn("setButtonBusyLabel(", index_html.text)
        self.assertIn("if(createReportButton?.disabled)return;", index_html.text)
        self.assertIn("report-name-help", index_html.text)
        self.assertIn("report-name-error", index_html.text)
        self.assertIn("report-base-url-error", index_html.text)
        self.assertIn("report-timeout-help", index_html.text)
        self.assertIn("setReportCreateFieldError(", index_html.text)
        self.assertIn("Report name is required", index_html.text)
        self.assertIn("Timeout seconds must be greater than zero", index_html.text)
        self.assertIn("field-invalid", index_html.text)
        self.assertIn("report-name-help report-name-error", index_html.text)
        self.assertIn("aria-live='polite'", index_html.text)
        self.assertIn("'creating…'", index_html.text)
        self.assertIn("'saving…'", index_html.text)
        self.assertIn("'deleting…'", index_html.text)
    ...
    def test_frontend_auth_protects_runtime_reports_and_supports_local_login(self):
        ...
        self.assertIn("stays persistent across restarts", login_page.text)
        self.assertIn("--reset-password", login_page.text)
        ...
        self.assertIn("stay signed in across browser restarts", settings.text)
        self.assertIn("Login throttle", settings.text)
        self.assertIn("Password reset", settings.text)
        self.assertIn("--reset-password", settings.text)
        ...
        self.assertIn("id='select-visible-results-button'", search_page.text)
        self.assertIn("id='deselect-visible-results-button'", search_page.text)
        self.assertIn("id='create-selected-report-button'", search_page.text)
        self.assertIn("selectedSearchTargets", search_page.text)
        self.assertIn("visibleActionTargets", search_page.text)
    ...
    def test_export_file_serving_endpoint(self):
        ...
        self.assertIn("export-create-error", exports_index.text)
        ...
        self.assertIn(f"export-row-error-{bundle_dir.name}", exports_index.text)
        self.assertIn(f"export-row-state-{bundle_dir.name}", exports_index.text)
        ...
        self.assertIn("setInlineManagerRowError(", exports_index.text)
        self.assertIn("setInlineManagerRowOutcome(", exports_index.text)
        self.assertIn("inline-state show", exports_index.text)
        self.assertIn("'saved'", exports_index.text)
        self.assertIn("'error'", exports_index.text)
        self.assertIn("setCreateExportBusyState(", exports_index.text)
        self.assertIn("setExportCreateError(", exports_index.text)
        self.assertIn("validateExportCreatePayload(", exports_index.text)
        self.assertIn("setExportCreateFieldState(", exports_index.text)
        self.assertIn("clearExportCreateFieldState(", exports_index.text)
        self.assertIn("focusExportCreateField(", exports_index.text)
        self.assertIn("setButtonBusyLabel(", exports_index.text)
        self.assertIn("if(createExportButton?.disabled)return;", exports_index.text)
        self.assertIn("export-workspace-help", exports_index.text)
        self.assertIn("export-workspace-error", exports_index.text)
        self.assertIn("export-channel-error", exports_index.text)
        self.assertIn("export-day-help", exports_index.text)
        self.assertIn("setExportCreateFieldError(", exports_index.text)
        self.assertIn("Workspace is required", exports_index.text)
        self.assertIn("Channel is required", exports_index.text)
        self.assertIn("Day is required", exports_index.text)
        self.assertIn("Day must use YYYY-MM-DD", exports_index.text)
        self.assertIn("field-invalid", exports_index.text)
        self.assertIn("export-day-help export-day-error", exports_index.text)
        self.assertIn("aria-live='polite'", exports_index.text)
        self.assertIn("'creating…'", exports_index.text)
        self.assertIn("'saving…'", exports_index.text)
        self.assertIn("'deleting…'", exports_index.text)
